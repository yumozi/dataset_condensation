...
def main():
    ...
    parser.add_argument('--method', type=str, default='DC', help='DC/DSA/Attack/CURE')
        ...
        for it in range(args.Iteration+1):
            ...
            if it in eval_it_pool:
                for model_eval in model_eval_pool:
                    ...
                    if args.dsa or args.attack or args.cure or args.dc_aug_param['strategy'] != 'none':
                    ...
                    for j, atk_args in enumerate(atk_args_ls):
                        ...
                        if it % 500 == 0 and it > 0:
                            eval_rounds = args.num_eval
                        else:
                            eval_rounds = 3
                        for it_eval in range(eval_rounds):
                            net_eval = get_network(model_eval, channel, num_classes, im_size, pre_norm=normalize).to(args.device) # get a random model
            ...
            net = get_network(args.model, channel, num_classes, im_size, pre_norm=normalize).to(args.device) # get a random model
            net.train()
            ...
            def prepare_bn(net, get_images, num_classes):
            ...
            for ol in range(args.outer_loop):
                ...
                for c in range(num_classes):
                    ...
                    if args.cure:
                        ...
                        outputs_pos = net(img_real + z)
                        outputs_orig = net(img_real)
                ...
                for il in range(args.inner_loop):
                    epoch('train', trainloader, net, optimizer_net, criterion, args, aug = True if args.dsa or args.attack or args.cure else False)
