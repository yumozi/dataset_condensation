...
def main():
    ...
    parser.add_argument('--method', type=str, default='DC', help='DC/DSA/Attack')
        ...
        for it in range(args.Iteration+1):
            ...
            for ol in range(args.outer_loop):
                ...
                for il in range(args.inner_loop):
                    epoch('train', trainloader, net, optimizer_net, criterion, args, aug = True if args.dsa or args.attack else False)
